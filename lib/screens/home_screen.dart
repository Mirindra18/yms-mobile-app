...
class HomeScreen extends StatelessWidget {
    ...
    return ListView(
      ...
      children: [
        ...
        if (progression.isNotEmpty) ...[
          const SizedBox(height: 24),
          _ReprendreCard(
            titre: reprendreTitre ?? 'Formation en ligne',
  ...
  List<({String titre, String texte, IconData icon})> _actualites(
    ...
    // On construit les actualités à partir du catalogue, en priorité
    // les formations à venir puis les formations en cours.
